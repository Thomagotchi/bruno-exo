export function DemoButtonPrimary() {
  return (
    <btn className="font-neue flex flex-row items-center w-fit h-40 text-secondary-medium-purple text-1s gap-8 px-12 border-default rounded-6 border-secondary-medium-purple">
